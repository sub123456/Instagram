<?php
		  ...
		  echo" <div class='menu-main-container' >
				 ...
				 <div class='comment-icon-container'>
				  ...
				  <div class='post-detail-container'>
				    ...
				    ".make_posts_comment($conn,$postId)."
 ...
 function make_posts($conn, $postId){
	   ...
	   function make_posts_comment($conn,$postId){
    ...
    if(isset($_POST['action_grid_post'])){
	    ...
	    while($row = mysqli_fetch_assoc($result)){
		  ...
		  if($postUrl==null){
			  ...
			  $post_url = "<img src='temp/post_image.png'/>";
			  
		  }else{
			  
			    $post_url = "<a href='#user-profile-grid' class='user_grid_button' data-action='grid'  data-post_id='$postId'><img src='$postUrl'/></a>";
		  ...
		  echo" <div class='menu-main-container' >
				 ...
				 <div class='comment-icon-container'>
				  ...
				  <div class='post-detail-container'>
					...
					".make_grid_posts_comment($conn ,$postId)."
	...
	function make_grid_posts_comment($conn ,$postId){
